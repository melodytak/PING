...
num_e=200; num_i=50;
sigma_e=0.05; i_ext_e=1.4*ones(num_e,1).*(1+sigma_e*randn(num_e,1)); 
sigma_i=0.00; i_ext_i=0.0*ones(num_i,1).*(1+sigma_i*randn(num_i,1));
g_hat_ee=0; g_hat_ei=.25; g_hat_ie=0.25; g_hat_ii=0.25; 
